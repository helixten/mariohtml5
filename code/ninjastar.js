...
Mario.NinjaStar.prototype = new Mario.NotchSprite();
...
Mario.NinjaStar.prototype.SubMove = function(xa, ya) {
    var collide = false;
...
Mario.NinjaStar.prototype.IsBlocking = function(x, y, xa, ya) {
    x = (x / 16) | 0;
    y = (y / 16) | 0;
...
Mario.NinjaStar.prototype.Die = function() {
	this.Dead = true;
